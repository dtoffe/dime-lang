...
function newBreakStatementNode(const source: sourceContext): astNode;
...
begin
  case kind of
    ...
    astBreakStatement: astNodeKindToString := 'BreakStmt';
...
function newBreakStatementNode(const source: sourceContext): astNode;
begin
  newBreakStatementNode := newAstNode(astBreakStatement, source)
end;
